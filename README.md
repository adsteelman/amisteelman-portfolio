...
export const siteConfig = {
  title: "Ami Steelman Portfolio",
  author: "Ami Steelman",
  url: "https://amisteelman.com",
  // ... more configuration
};
```
...
```css
@theme {
  --color-primary: #1C90C5;
  --color-primary-dark: #AAD4E9;
